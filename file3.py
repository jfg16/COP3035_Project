...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        title = tk.Label(self, text=student_name + "'s Home Page"+"\n\nCourse: "+course_code+"\nSemester: "+semester+"\nStudent ID: "+ID, font=('times', 20))
        title.pack(padx=10, pady=10)
        ###
        button1 = ttk.Button(self, text="View Overall Grade", command=lambda: controller.show_frame(Page1))
        button1.pack()
        button2 = ttk.Button(self, text="View \"" + weightnames[0]+"\"", command=lambda: controller.show_frame(Page2))
        button2.pack()
        button3 = ttk.Button(self, text="View \"" + weightnames[1]+"\"", command=lambda: controller.show_frame(Page3))
        button3.pack()
        button4 = ttk.Button(self, text="View \"" + weightnames[2]+"\"", command=lambda: controller.show_frame(Page4))
        button4.pack()
        button5 = ttk.Button(self, text="View \"" + weightnames[3]+"\"", command=lambda: controller.show_frame(Page5))
        button5.pack()
        button6 = ttk.Button(self, text="View \"" + weightnames[4]+"\"", command=lambda: controller.show_frame(Page6))
        button6.pack()
        button7 = ttk.Button(self, text="View \"" + weightnames[5]+"\"", command=lambda: controller.show_frame(Page7))
        button7.pack()
...
class Page1(tk.Frame):
    def __init__(self, parent, controller):
        ##
        tk.Frame.__init__(self, parent)
        title = tk.Label(self, text="Overall Grade", font=('times', 20))  
        title.pack(padx=10, pady=10)
        ##
        ...
        text1 = tk.Label(self, text="Your final overall grade: "+str(selected_grade)+"%",font =('times', 15)) 
...
class Page2(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        title = tk.Label(self, text=weightnames[0], font=('times', 20))
        title.pack(padx=10, pady=10)
        ...
        text1 = tk.Label(self, text="Your grade on this assignment: "+str(student_grades[0])+"%",font =('times', 15))
...
class Page3(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        title = tk.Label(self, text=weightnames[1], font=('times', 20))
        title.pack(padx=10, pady=10)
        ...
        text1 = tk.Label(self, text="Your grade on this assignment: "+str(student_grades[1])+"%",font =('times', 15))
        text1.place(x=5,y=65)
...
class Page4(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        title = tk.Label(self, text=weightnames[2], font=('times', 20))
        title.pack(padx=10, pady=10)
        ...
        text1 = tk.Label(self, text="Your grade on this assignment: "+str(student_grades[2])+"%",font =('times', 15))
        text1.place(x=5,y=65)
...
class Page5(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        title = tk.Label(self, text=weightnames[3], font=('times', 20))
        title.pack(padx=10, pady=10)
        ...
        text1 = tk.Label(self, text="Your grade on this assignment: "+str(student_grades[3])+"%",font =('times', 15))
        text1.place(x=5,y=65)
...
class Page6(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        title = tk.Label(self, text=weightnames[4], font=('times', 20))
        title.pack(padx=10, pady=10)
...
class Page7(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        title = tk.Label(self, text=weightnames[5], font=('times', 20))
        title.pack(padx=10, pady=10)
        ...
        text1 = tk.Label(self, text="Your grade on this assignment: "+str(student_grades[5])+"%",font =('times', 15))
        text1.place(x=5,y=65)
...
def pie_chart():  # Function that creates a pie chart
    ...
    test = ['A', 'B', 'C', 'D', 'F']
    labels = list(test)
    colors = ['darkred', 'goldenrod', 'darkseagreen', 'lightskyblue', 'dimgrey']
...
def histogram(n):
    ...
    f = Figure(figsize=(5, 5), dpi=100)
    graph = f.add_subplot(111)
    graph.hist(n, number_bins, facecolor='burlywood', alpha=0.5)
    return f
